...
<body>
	<div class="all">
		<sf:form action="${ctx}/Var/editAction" method="post" modelAttribute="envVarModel">
			<div class="whole">
				<div class="littletitle">编辑变量</div>
				<input class="form-control" id="id" name="id" type="hidden" value="${envVarModel.id}">
