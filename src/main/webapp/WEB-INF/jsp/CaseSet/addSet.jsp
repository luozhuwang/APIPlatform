...
// 	var Relations=$('#caseRelation').find("option:selected").attr('val')
	...
	$.ajax({  
        type : "post",  
        url : "../CaseSet/addSetAction",  
        data:{caseSetName:caseSetName,caseRelation:caseRelation,remark:remark},  
        dataType: "text",       
        cache: false,
...
<body>
	<div class="widget-content nopadding">
				<div class="panel-body">
					...
					<div class="col-sm-2">
						<input class="form-control" id="caseSetName" name="caseSetName" type="text"  placeholder="用例集名称">
					</div>								 
				</div>
				<div class="panel-body">
					<label for="id_select" class="col-sm-1 control-label">关联用例</label>
					<div>
						<select id="caseRelation" name="caseRelation" class="selectpicker bla bla bli col-sm-8" multiple data-live-search="true" value="" title="请选择用例(支持多选)">
				...
				<div class="panel-body">
					...
					<div  class="col-sm-8" >
						<textarea class="form-control" rows="4" style="resize: none;" id="remark" name="remark" placeholder="用例集描述"></textarea>
					</div>					  
				</div>
			<div align="center" class="col-sm-10">				
				<button  class="btn btn-success btn-lg" value="保存" onclick="setAddAction();">保存</button>
