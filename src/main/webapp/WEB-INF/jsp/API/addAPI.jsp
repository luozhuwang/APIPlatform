...
<body>
	<div class="widget-content nopadding" align="center">
		<sf:form   action="${ctx}/Interface/addAPIAction" method="post" class="form-horizontal" modelAttribute="APImodel">
...
www.xiaoniu88.com映射环境NginxIP',配置为https,不需要带端口" style="color:red">域名帮助</a>
				...
				<div class="panel-body">
						...
						<div class="col-sm-2">
							<select class="selectpicker form-control" id="apiMethod" name="apiMethod" style="height: 30px">
								<option value="get">get</option>
								<option value="post">post</option>
								<option value="post1">post加密</option>
							</select>
						</div>							
						<label class="col-sm-1 control-label">状态</label>
						<div class="col-sm-2">						
							<label class="radio-inline">
								<input type="radio" name="apiStatus" id="apiStatus" value="0" checked> 启用
							</label>
							<label class="radio-inline">
								<input type="radio" name="apiStatus" id="apiStatus"  value="1">暂停
							</label>
						</div>
				</div>
			</div>		
			...
			<div class="panel panel-info" style="width: 70%; height: 160px">
				...
				<div class="panel-body">
					<textarea class="form-control" rows="4" style="resize: none;" id="apiHeaders" name="apiHeaders" placeholder="请求头"></textarea>
				</div>
			</div>
			-->
