...
public class NewTestSetResultListener extends TestListenerAdapter{
...
//		System.out.println("结束时间："+sdf.format(testContext.getEndDate()));
		...
		caseSetResult.addSetResult(CaseSetController.caseSetid, start, end, (endDate.getTime()-startDate.getTime()),CaseSetController.runEnv,CaseSetController.bath);
...
//                     System.out.println("结果状态："+result.getStatus());
                   ...
                   //这种方式不需要添加@ContextConfiguration
                     ...
                     caseResultDao.addCaseResult(caseId,CaseSetController.caseSetid, FormatTime(result.getStartMillis()), FormatTime(result.getEndMillis()), costTime, resultstatus,CaseSetController.runEnv,CaseSetController.bath);
            	}
