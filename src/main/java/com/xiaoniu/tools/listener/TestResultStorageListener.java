...
//                    CaseResultModel runcase=JSON.parseObject(JSON.toJSON(param).toString(), CaseResultModel.class);
                  ...
                  //这种方式不需要添加@ContextConfiguration
                    ...
                    //用例执行完，setId为0
//                    caseResultDao.addCaseResult(caseid,0, FormatTime(result.getStartMillis()), FormatTime(result.getEndMillis()), costTime, resultstatus,0);
                }	
    		}
		}
